...
- Generated at: 2026-04-20T09:05:13
- Scope: test/case
- Exit status: 1
- Passed: 0
- Failed: 1
...
- Failure:
```
isolated_case_runtime = <nethub_runtime.core.services.core_engine.AICore object at 0x7f52f033b980>
...
E       assert 'tanaka@tech.co.jp' in "{'message': '当前没有找到对应的供应商资料信息。', 'answer': None, 'knowledge_hits': []}"
E        +  where "{'message': '当前没有找到对应的供应商资料信息。', 'answer': None, 'knowledge_hits': []}" = str((None or {'answer': None, 'knowledge_hits': [], 'message': '当前没有找到对应的供应商资料信息。'}))
E        +    where None = <built-in method get of dict object at 0x7f52f026d980>('answer')
E        +      where <built-in method get of dict object at 0x7f52f026d980> = {'answer': None, 'knowledge_hits': [], 'message': '当前没有找到对应的供应商资料信息。'}.get
