...
- Generated at: 2026-04-20T08:58:12
- Scope: test/case
- Exit status: 1
- Passed: 0
- Failed: 1
...
- Failure:
```
isolated_case_runtime = <nethub_runtime.core.services.core_engine.AICore object at 0x7fcf0851b3e0>
...
E        +    where None = <built-in method get of dict object at 0x7fcf0844e240>('answer')
E        +      where <built-in method get of dict object at 0x7fcf0844e240> = {'answer': None, 'knowledge_hits': [], 'message': '当前没有找到对应的信息条目信息。'}.get
