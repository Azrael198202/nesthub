...
- Generated at: 2026-04-20T08:53:19
- Scope: test/case
- Exit status: 1
- Passed: 4
- Failed: 2
...
- Failure:
```
isolated_case_budget_runtime = <nethub_runtime.core.services.core_engine.AICore object at 0x7f5568d3c500>
...
- Failure:
```
isolated_case_runtime = <nethub_runtime.core.services.core_engine.AICore object at 0x7f5568cc8290>
...
E       assert 'tanaka@tech.co.jp' in "{'message': '当前没有找到对应的信息条目信息。', 'answer': None, 'knowledge_hits': []}"
E        +  where "{'message': '当前没有找到对应的信息条目信息。', 'answer': None, 'knowledge_hits': []}" = str((None or {'answer': None, 'knowledge_hits': [], 'message': '当前没有找到对应的信息条目信息。'}))
E        +    where None = <built-in method get of dict object at 0x7f5563f51a00>('answer')
E        +      where <built-in method get of dict object at 0x7f5563f51a00> = {'answer': None, 'knowledge_hits': [], 'message': '当前没有找到对应的信息条目信息。'}.get

test/case/test_e2e_information_agent_lifecycle.py:99: AssertionError
```
