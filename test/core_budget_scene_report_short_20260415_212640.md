...
{
  "trace_id": "trace_c181d304c782",
  "session_id": "budget_scene_e2e",
  "task": {
    "task_id": "task_ad6f14360a3f",
    "intent": "data_record",
  ...
  "workflow": {
    "workflow_id": "workflow_001949a83ede",
    "task_id": "task_ad6f14360a3f",
    "mode": "normal",
    "steps": [
      {
        "step_id": "step_5e55e8c7ad57",
          ...
          "records": [
            {
              ...
              "created_at": "2026-04-15T12:26:40.456917+00:00"
            },
            {
              "time": "今天",
              "location": null,
              ...
              "created_at": "2026-04-15T12:26:40.456935+00:00"
            },
            {
              "time": "unspecified",
              "location": null,
              ...
              "label": "other",
              "raw_text": "买了书1200日元",
              "created_at": "2026-04-15T12:26:40.456948+00:00"
            },
            {
              "time": "上周",
              ...
              "created_at": "2026-04-15T12:26:40.456958+00:00"
            }
          ],
          "count": 4
        }
...
{
  "trace_id": "trace_392f73f1ba72",
  "session_id": "budget_scene_e2e",
  "task": {
    "task_id": "task_f289a3a9d5f2",
    "intent": "data_query",
  ...
  "workflow": {
    "workflow_id": "workflow_f955d40f1ba0",
    "task_id": "task_f289a3a9d5f2",
    "mode": "normal",
    "steps": [
      {
        "step_id": "step_94ff2c392539",
        "name": "parse_query",
  ...
  "execution_result": {
    "steps": [
      ...
      },
      {
        ...
        "name": "aggregate_query",
        "status": "failed",
        "error": "'ExecutionCoordinator' object has no attribute '_record_matches_time_marker'"
      }
    ],
...
{
  "trace_id": "trace_c9a550edc9e3",
  "session_id": "budget_scene_e2e",
  "task": {
    "task_id": "task_7fab71a5dc1f",
    "intent": "data_query",
  ...
  "workflow": {
    "workflow_id": "workflow_707b23487a21",
    "task_id": "task_7fab71a5dc1f",
    "mode": "normal",
    "steps": [
      {
        "step_id": "step_ab3f0b3e1b49",
        "name": "parse_query",
        "task_type": "data_query",
        "depends_on": [],
        "retry": 1,
